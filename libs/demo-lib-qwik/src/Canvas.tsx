import { component$, useVisibleTask$, useSignal, $, noSerialize, QRL } from '@builder.io/qwik'
...
export const Canvas = component$<CanvasProps>(({ setup, draw }) => {
  ...
  return (
    <div ref={containerRef} class="canvas-container w-full h-full flex flex-col items-stretch justify-stretch overflow-hidden">
      <canvas
        ref={canvasRef}
      />
    </div>
